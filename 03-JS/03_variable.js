...
// -키워드(예약어) 사용 불가능
//      > 키워드란? 이미 특별한 역할을 하고 있는 단어(ex. let, const, void, return, for, while ...)
// - 숫자로 시작 x
// - 특수문자 : _ , $ 만 사용 가능
// - 공백문자(space bar) x

// Q. 식별자에 단어 두개 이상 작성하고 싶은 경우?
// A. camelCase / snake_case (ex.appleCake, lemon_ade)

// Q. 상수란?
// A. 프로그램이 실행되는 동안 값이 변하지 않는 데이터를 나타냄
//    한번 정의되면 프로그램 실행 중에는 변경되지 않는 값을 말함 고정된 값
//    보통 대문자로 표기 (ex. PEACH, ORANGE)