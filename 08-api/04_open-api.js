// OMDb API // https://www.omdbapi.com/?i=tt3896198&apikey=f3cd24e8
// apikey=f3cd24e8
// API 키는 필수
// OMDb API를 사용햐 영화 데이터를 비동기적으로 불러오고, 웹 페이지에 표시하는 예시.
...
async function getMovieData() {
    ...
    const res = await fetch(
        `https://www.omdbapi.com/?s=${word}&apikey=f3cd24e8`,
    );
